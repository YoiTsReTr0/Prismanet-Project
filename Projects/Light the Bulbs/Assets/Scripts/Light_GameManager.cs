...
public class Light_GameManager : MonoBehaviour
{
    public static Light_GameManager instance;

    #region Local Variables

    private Light_UIManager _uiManager;
    ...
    private void Start()
    {
        _uiManager = Light_UIManager.instance;
